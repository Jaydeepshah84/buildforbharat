        ...
        <div className="flex-1 relative overflow-hidden flex" onClick={handlePlay}>
          ...
          <div className="w-[45%] lg:w-[40%] relative bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] flex items-center justify-center">
            ...
            <div className="relative" style={{ width: '80%', maxWidth: 280 }}>
              {/* Head — detailed SVG face */}
              <motion.div
                animate={{ rotateZ: avatarExpression === 'thinking' ? [-2, 2, -2] : [0, 0] }}
              ...
              >
                <svg viewBox="0 0 120 140" className="w-full">
                  {/* Face */}
                  <ellipse cx="60" cy="65" rx="48" ry="54" fill="#FFCBA4" />

                  {/* Hair */}
                  <ellipse cx="60" cy="30" rx="48" ry="28" fill="#3B2314" />
                  <rect x="12" y="24" width="96" height="16" rx="8" fill="#3B2314" />

                  {/* Ears */}
                  <ellipse cx="12" cy="68" rx="8" ry="13" fill="#E8B89D" />
                  <ellipse cx="108" cy="68" rx="8" ry="13" fill="#E8B89D" />
                  <ellipse cx="12" cy="68" rx="4" ry="7" fill="#D4A088" />
                  <ellipse cx="108" cy="68" rx="4" ry="7" fill="#D4A088" />

                  {/* Eyebrows */}
                  <motion.path d="M30,50 Q42,44 54,49" fill="none" stroke="#3B2314" strokeWidth="3.5" strokeLinecap="round"
                    animate={{ d: avatarExpression === 'emphasize' ? "M30,46 Q42,40 54,45" : avatarExpression === 'thinking' ? "M30,48 Q42,43 54,50" : "M30,50 Q42,44 54,49" }}
                    transition={{ duration: 0.3 }} />
                  <motion.path d="M66,49 Q78,44 90,50" fill="none" stroke="#3B2314" strokeWidth="3.5" strokeLinecap="round"
                    animate={{ d: avatarExpression === 'emphasize' ? "M66,45 Q78,40 90,46" : avatarExpression === 'thinking' ? "M66,50 Q78,43 90,48" : "M66,49 Q78,44 90,50" }}
                    transition={{ duration: 0.3 }} />
                  ...
                  >
                    <ellipse cx="40" cy="62" rx="8" ry="9" fill="white" />
                    <ellipse cx="80" cy="62" rx="8" ry="9" fill="white" />
                    <motion.circle cx="41" cy="63" r="5" fill="#4A3728"
                      animate={{ cx: avatarExpression === 'thinking' ? 43 : 41 }}
                      transition={{ duration: 0.5 }} />
                    <motion.circle cx="81" cy="63" r="5" fill="#4A3728"
                      animate={{ cx: avatarExpression === 'thinking' ? 83 : 81 }}
                      transition={{ duration: 0.5 }} />
                    <circle cx="41.5" cy="63.5" r="2.5" fill="#1a1a1a" />
                    <circle cx="81.5" cy="63.5" r="2.5" fill="#1a1a1a" />
                    <circle cx="43" cy="61" r="1.5" fill="white" />
                    <circle cx="83" cy="61" r="1.5" fill="white" />
                  </motion.g>

                  {/* Nose */}
                  <path d="M55,78 Q60,86 65,78" fill="none" stroke="#D4A088" strokeWidth="2" strokeLinecap="round" />
                  <circle cx="55" cy="80" r="2" fill="#E0A88A" />
                  <circle cx="65" cy="80" r="2" fill="#E0A88A" />

                  {/* Mouth */}
                  {avatarExpression === 'smile' ? (
                    <path d="M45,95 Q60,108 75,95" fill="none" stroke="#C96B5A" strokeWidth="2.5" strokeLinecap="round" />
                  ) : isPlaying ? (
                    <motion.ellipse cx="60" cy="97" fill="#C96B5A"
                      animate={{ rx: [6, 9, 5, 8, 6], ry: [3, 6, 2, 5, 3] }}
                      transition={{ duration: 1.2, repeat: Infinity }} />
                  ) : (
                    <path d="M48,96 Q60,102 72,96" fill="none" stroke="#C96B5A" strokeWidth="2" strokeLinecap="round" />
                  )}

                  {/* Neck */}
                  <rect x="48" y="116" width="24" height="24" rx="8" fill="#FFCBA4" />
                </svg>
              </motion.div>
