"use client";
// ============================================================
// NotesPage - Complete rewrite for LearnerAI
...
const SOURCE_STYLES = {
  topic: { bg: 'bg-primary-100', text: 'text-[#1e40af]', label: 'Topic' },
...
function RenderedNotes({ markdown }) {
  return (
    <div className="rendered-notes prose prose-sm sm:prose max-w-none
      ...
      prose-h2:text-xl prose-h2:font-semibold prose-h2:mt-6 prose-h2:mb-3 prose-h2:text-[#1e40af]
      prose-h3:text-lg prose-h3:font-semibold prose-h3:text-gray-800
      prose-p:text-gray-700 prose-p:leading-relaxed
      prose-li:text-gray-700
      prose-strong:text-[#1e40af]
      prose-blockquote:border-l-[#1e40af] prose-blockquote:bg-primary-50/50 prose-blockquote:rounded-r-lg prose-blockquote:py-1 prose-blockquote:px-4
      prose-code:bg-gray-100 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:text-[#1e40af]
      prose-a:text-[#1e40af]"
    >
...
export default function NotesPage() {
  ...
  const handleDownloadPDF = () => {
    ...
    printWindow.document.write(`
      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          strong { color: #4338ca; }
          blockquote { border-left: 4px solid #1e40af; background: #eef2ff; padding: 12px 16px; margin: 12px 0; border-radius: 0 8px 8px 0; }
      ...
      <body>
        <div id="content"></div>
        <div class="footer">Generated by LearnerAI</div>
      </body>
      </html>
    `);
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <motion.div variants={fadeIn} initial="hidden" animate="visible">
          <div className="flex items-center gap-3 mb-1">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#1e40af] to-[#5b7cf7] flex items-center justify-center text-white shadow-lg shadow-primary-200">
                  ...
                  {methods.map((m) => (
                    <button
                      ...
                      className={`flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl text-sm font-medium transition-all duration-200 ${
                        method === m.id
                          ? 'bg-primary-50 text-[#1e40af] border border-primary-200 shadow-sm'
                  ...
                  <div className="p-6 space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e40af] focus:border-transparent transition-shadow"
                      />
                    </div>
                    <button
                      onClick={handleGenerateFromTopic}
                      disabled={generating || !topicName.trim()}
                      className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#1e40af] text-white text-sm font-semibold hover:bg-primary-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-primary-200"
                    >
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    {audioURL && (
                      <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                        <div className="flex items-center gap-3 mb-2">
                          <Volume2 className="w-4 h-4 text-[#1e40af]" />
                    ...
                    {transcribedText && (
                      <div className="bg-primary-50 rounded-xl p-4 border border-primary-100">
                        <h4 className="text-sm font-semibold text-[#1e40af] mb-2">Transcribed Text</h4>
                  ...
                  <div className="p-6 space-y-4">
                    <div>
                      ...
                      <textarea
                        ...
                        rows={8}
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#1e40af] focus:border-transparent resize-none transition-shadow"
                      />
                    </div>
                    <button
                ...
                >
                  <div className="flex flex-col items-center gap-4">
                    <div className="relative">
                      ...
                      />
                      <Sparkles className="w-7 h-7 text-[#1e40af] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                    </div>
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-3">
                      ...
                      <button
                        ...
                        disabled={savingNote}
                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#1e40af] text-white text-sm font-semibold hover:bg-primary-700 transition-colors shadow-md shadow-primary-200 disabled:opacity-50"
                      >
                        {savingNote ? (
            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[#1e40af] focus:border-transparent shadow-sm transition-shadow"
                />
              </div>
                ...
                <div className="text-center py-20 bg-white rounded-2xl border border-gray-200 shadow-sm">
                  ...
                  {!searchQuery && (
                    <button
                      ...
                      className="mt-4 inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-[#1e40af] text-white text-sm font-semibold hover:bg-primary-700 transition-colors shadow-md shadow-primary-200"
                    >
                      ...
                      <motion.div key={noteId} variants={cardPop} layout>
                        <div
                          ...
                          className={`rounded-2xl border cursor-pointer transition-all duration-200 hover:shadow-md ${
                            isExpanded
                              ? 'border-primary-200 bg-primary-50/30 shadow-md col-span-1 md:col-span-2'
                        ...
                        >
                          ...
                          <div className="p-4 flex items-start justify-between gap-3">
                            <div className="flex items-start gap-3 min-w-0">
                              <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-primary-100 text-[#1e40af] flex items-center justify-center">
